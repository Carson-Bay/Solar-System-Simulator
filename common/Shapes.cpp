...
Mesh pretty_icosahedron()
{
    ...
    for (int n = 0; n < 19; n++)
    {
        ...
        uint32_t xCoord = 11 + (636145253291 * n) / 16628040 - (78938537703859 * pow(n, 2)) / 593762400 + (30933962001881143 * pow(n, 3)) / 154378224000 - (4440468867823147 * pow(n, 4)) / 
        25147584000 + (1374150132247921 * pow(n, 5)) / 13343616000 - (250274450610701843 * pow(n, 6)) / 5884534656000 + (76303262679539969 * pow(n, 7)) / 5884534656000 - (329008179121427 * 
        pow(n, 8)) / 109734912000 + (1291809100301603 * pow(n, 9)) / 2414168064000 - (1022030472749 * pow(n, 10)) / 13716864000 + (1403116522211 * pow(n, 11)) / 172440576000 - (1261909404557 * 
        pow(n, 12)) / 1810626048000 + (2192509003819 * pow(n, 13)) / 47076277248000 - (724175777 * pow(n, 14)) / 301771008000 + (366416387 * pow(n, 15)) / 3923023104000 - (3203209 * pow(n, 16))
        / 1207084032000 + (3955513 * pow(n, 17)) / 76218734592000 - (11353 * pow(n, 18)) / 18188561664000 + (10579 * pow(n, 19)) / 3041127510220800;

        uint32_t yCoord = 1 - (9660626251307 * n) / 116396280 + (629002586131 * pow(n, 2)) / 2199120 - (4121518679857603 * pow(n, 3)) / 9648639000 + (739056863873557 * pow(n, 4)) / 1981324800 - 
        (2712238512333949 * pow(n, 5)) / 12573792000 + (173418304943811259 * pow(n, 6)) / 1961511552000 - (5729992275660019 * pow(n, 7)) / 213983078400 + (495515178551413 * pow(n, 8)) 
        / 80472268800 - (330151293553507 * pow(n, 9)) / 301771008000 + (2776426699903 * pow(n, 10)) / 18289152000 - (79836295257839 * pow(n, 11)) / 4828336128000 + (170645375777 * pow(n, 12)) 
        / 120708403200 - (4442308807723 * pow(n, 13)) / 47076277248000 + (22219573 * pow(n, 14)) / 4572288000 - (5935915177 * pow(n, 15)) / 31384184832000 + (5623801 * pow(n, 16)) / 
        1046139494400 - (196267 * pow(n, 17)) / 1865493504000 + (168953 * pow(n, 18)) / 133382785536000 - (429899 * pow(n, 19)) / 60822550204416000;

        uint32_t zCoord = 3 + (1018960391389 * n) / 15519504 - (6985019619679817 * pow(n, 2)) / 30875644800 + (78844765318729 * pow(n, 3)) / 233376000 - (4239826677807953 * pow(n, 4)) / 
        14370048000 + (223183097586838867 * pow(n, 5)) / 1307674368000 - (102962341257758791 * pow(n, 6)) / 1471133664000 + (38407681414167817 * pow(n, 7)) / 1810626048000 - (2142714693360211 
        * pow(n, 8)) / 438939648000 + (598726983175367 * pow(n, 9)) / 689762304000 - (15116515409659 * pow(n, 10)) / 125411328000 + (126865077327869 * pow(n, 11)) / 9656672256000 - 
        (508711662211 * pow(n, 12)) / 452656512000 + (3532831818731 * pow(n, 13)) / 47076277248000 - (242635251253 * pow(n, 14)) / 62768369664000 + (1349130073 * pow(n, 15)) / 8966909952000 - 
        (2949341 * pow(n, 16)) / 689762304000 + (89271043 * pow(n, 17)) / 1067062284288000 - (586003 * pow(n, 18)) / 582033973248000 + (52541 * pow(n, 19)) / 9357315416064000;
